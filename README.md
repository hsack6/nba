...
+ 動作チェック。
    - グラフ見て未知+復帰が出現になっているかどうか
+ リンク逆方向を含んでいる．

# 班ミーティング2019/1/11
## 16日10時　発表練習(佐々木先生)
## タイトル
GNNを用いた未知ノードの出現を考慮した時系列グラフの予測
## 優先順位
1．出力まで一通り、2．簡単な評価、3．論文データ、4．GED等の評価
## 評価
+ ノード数が正しいか
+ リンク数が正しいか
+ ノード属性の評価は一対一対応できるもののみ(少なくとも未知はできない)
+ リンク集合 recall precision F
+ 未知ノードが持つ属性に大まかな割合(histogramとか)
+ 未知ノードと隣接ノードのリンクについはGED。トポロジのみ。
